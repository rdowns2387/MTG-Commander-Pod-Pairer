    ...
    <div className="main-content">
      ...
      <div className="queue-status">
        <div>
          ...
          <p>
            Your status: <strong>{queueStatus.inQueue ? 'In Queue' : 'Not in Queue'}</strong>
      ...
      <div className="card">
        ...
        <div className="card-body">
          <ol>
            ...
            <li>Once enough players are available, you'll be assigned to a pod of 4 players</li>
            <li>You'll have 2 minutes to confirm your spot in the pod</li>
            <li>After your game, you can rate the other players and join the queue for another game</li>
            <li>The system will try to pair you with players you haven't played with before</li>
          </ol>
        </div>
      </div>
    </div>
